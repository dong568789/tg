...
;(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    ...
    init : function() {
      ...
      this.setMinHeight();
	  $(".jp-first").html("<i class=\"zmdi zmdi-more-horiz\"></i>");
	  $(".jp-previous").html("<i class=\"zmdi zmdi-chevron-left\"></i>");
	  $(".jp-next").html("<i class=\"zmdi zmdi-chevron-right\"></i>");
	  $(".jp-last").html("<i class=\"zmdi zmdi-more-horiz\"></i>");
    },
