...
(function(window, document) {
  ...
  var modalClass   = '.sweet-alert',
      ...
      alertTypes   = ['error', 'warning', 'info', 'success', 'hold'],
      defaultParams = {
        title: '',
        text: '',
        type: null,
  ...
  window.sweetAlertInitialize = function() {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div>' +
					...
					'<div class="icon hold"><div class="preloader pl-xl pls-blue"><svg class="pl-circular" viewBox="25 25 50 50"><circle class="plc-path" cx="50" cy="50" r="20" /></svg></div></div>' +
					...
					'<h2>Title</h2><p class="lead text-muted">Text</p><p><button class="cancel btn btn-lg" tabIndex="2">Cancel</button> <button class="confirm btn btn-lg" tabIndex="1">OK</button></p></div>',
