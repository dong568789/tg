...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
        ...
        rowCount: [50, 100], // rows per page int or array of int (-1 represents "All")
        ...
        css: {
			...
			addnewuser: "btn btn-primary btn-default waves-effect btn-addnewuser",
			channelselect: "btn btn-default dropdown-menu f-14 waves-effect channel-select",
        ...
        labels: {
            all: "全部",
            infos: "显示全部 {{ctx.total}} 条数据的 第 {{ctx.start}} 至 {{ctx.end}} 条",
            loading: "加载中...",
            noResults: "没有数据!",
            refresh: "刷新",
            search: "搜索"
