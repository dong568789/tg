            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="p-20">
                                <form id="addgame" class="form-horizontal" enctype="multipart/form-data" role="form" action="index.php?m=game&a=addgame" method="post" >
										...
										<div class="col-sm-7">
											<div class="fg-line">
												<select class="chosen" name="sdkgameid" id="sdkgameid" data-placeholder="请选择对应的SDK游戏，输入框可进行搜索">
													<option value="0" selected="true">请选择对应的SDK游戏，输入框可进行搜索</option>
													<foreach name="sdkgamelist" item="vo" key="k">
														<option value="<{$vo['id']}>"><{$vo['initial']}> <{$vo['name']}></option>
													</foreach>
												</select>
												<foreach name="sdkgamelist" item="vo" key="k">
									...
									<div class="form-group m-t-25">
										...
										<div class="col-sm-7">
											<div class="fg-line">
												<input type="text" class="form-control" name="gamename" id="gamename" placeholder="游戏名称(选择SDK后自动完成)" value="">
											</div>
										</div>
									</div>
									<div class="form-group m-t-25">
										...
										<div class="col-sm-7">
											<div class="fg-line">
												<input type="text" class="form-control" name="gamepinyin" id="gamepinyin" placeholder="游戏拼音(选择SDK后自动完成)" value="">
											</div>
										</div>
									</div>
                                    <div class="form-group m-t-25">
									...
									<!-- 暂时禁用
									<div class="form-group m-t-25">
                                        <label class="col-sm-3 f-15 control-label">分成模式</label>
                                        <div class="col-sm-7">
                                            <div class="fg-line">
                                                <label class="radio radio-inline m-r-20">
                                                    <input class="radioclass" type="radio" name="sharetype" value="CPS" checked="true">
                                                    <i class="input-helper p-relative" style="left:-26px;"></i>
                                                    CPS
                                                </label>

                                                <label class="radio radio-inline m-r-20">
                                                    <input class="radioclass" type="radio" name="sharetype" value="CPA">
                                                    <i class="input-helper p-relative" style="left:-26px;"></i>
                                                    CPA
                                                </label>
                                            </div>
									...
									<div class="form-group m-t-25">
										<label class="col-sm-3 f-15 control-label">上传游戏白包</label>
