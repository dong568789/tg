...
<script type="text/javascript">
    ...
    function selectGame () {
        ...
        $.ajax({
            type: "POST",
            url: "<{:U('source/selectGame',array('uid' => $tguserid))}>",
    ...
    function downloadUrl(sourcesn)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<{:U('source/getGameDowUrl',array('uid' => $tguserid))}>",
    ...
    function downloadTextture (sourcesn) {
        ...
        $.ajax({
            type: "POST",
            url: "<{:U('source/downloadTextture',array('uid' => $tguserid))}>",
            data: {source : sourcesn},
            cache: false,
            dataType: 'json',
            success: function (data) {
    ...
    $(document).ready(function() {
        ...
        $('body').on('click','.app-apply', function(){
            ...
            swal({
				...
				if (isdoingapply == 0) {
					$.ajax({
						type: "POST",
						url: "<{:U('source/applyGame',array('uid' => $tguserid))}>",
		...
		$("#searchGame").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<{:U('source/searchGame',array('uid' => $tguserid))}>",
    ...
    $(function (argument) {
        ...
        function getsourceData()
        {
            ...
            $.ajax({
                type: "POST",
                url: "<{:U('source/selectSource',array('uid' => $tguserid))}>",
                data: {content : searchContent, channelid : searchchannelid},
                cache: false,
                dataType: 'json',
                success: function (data) {
