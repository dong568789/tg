                            ...
                            <div class="p-20">
                                <form class="form-horizontal" id="addchannel" role="form">
                                    ...
                                    <div class="form-group m-t-25">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="fg-line">
                                                <input type="password" class="form-control" name="sub_password" id="sub_password" maxlength="20" />
                                            </div>
                                        </div>
                                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#savechannel').click(function() {
            ...
            if ($('#addchannel').valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<{:U('channel/addchannel',array('uid' => $tguserid))}>",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        if (data.data == "success") {
                            ...
                            setTimeout(function () {
                                location.href = '/channel/<{$tguserid}>/';
                            }, 1000);
                        }else{
